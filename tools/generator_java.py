...
class GeneratorJava:
    OUT_FILE_NAME = "JosFeature.java"
    mOutConfDir = ''
    mOutConfPath = ''

    def __init__(self, outdir_root_dir):
        self.mOutConfDir = os.path.join(outdir_root_dir, "java/com/journeyOS/")
    ...
    def generate(self, features):
        ...
        with open(self.mOutConfPath, 'w+') as f:
            ...
            f.write("package com.journeyOS;\n\n")
            f.write("public final class JosFeature {\n\n")
